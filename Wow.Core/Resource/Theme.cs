...
namespace Wow.Core.Resource
{
    public class Theme
    {
        ...
        public Theme()
        {
            ...
            // https://github.com/Wow-launcher/Wow/issues/2935
        ...
        private void MakesureThemeDirectoriesExist()
        {
            foreach (string dir in _themeDirectories)
            {
                if (!Directory.Exists(dir))
                {
                    ...
                    {
                        Logger.WowError($"Exception when create directory <{dir}>", e);
                    }
                }
            }
        }
        ...
        public bool ChangeTheme(string theme)
        {
            ...
            {
                Logger.WowError($"Theme <{theme}> path can't be found");
            ...
            {
                Logger.WowError($"Theme <{theme}> fail to parse");
                if (theme != defaultTheme)
                {
