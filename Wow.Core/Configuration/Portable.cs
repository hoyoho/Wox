...
namespace Wow.Core.Configuration
{
    public class Portable : IPortable
    {
        ...
        {
            return new UpdateManager(string.Empty, Constant.Wow, Constant.RootDirectory);
        }
        ...
        public void DisablePortableMode()
        {
            try
            {
                ...
                MessageBox.Show("Wow needs to restart to finish disabling portable mode, " +
            ...
            {
#if !DEBUG
                Logger.WowError("Error occured while disabling portable mode", e);
#endif
                throw;
            }
        }
        ...
        public void EnablePortableMode()
        {
            try
            {
                ...
                MessageBox.Show("Wow needs to restart to finish enabling portable mode, " +
            ...
            {
#if !DEBUG
                Logger.WowError("Error occured while enabling portable mode", e);
#endif
                throw;
            }
        }
        ...
        public void CreateUninstallerEntry()
        {
            ...
            var key = RegistryKey.OpenBaseKey(RegistryHive.CurrentUser, RegistryView.Default)
                .CreateSubKey(uninstallRegSubKey + "\\" + Constant.Wow, RegistryKeyPermissionCheck.ReadWriteSubTree);
        ...
        public void PreStartCleanUpAfterPortabilityUpdate()
        {
            ...
            var roamingDataPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Wow");
            ...
            if (DataLocationRoamingDeleteRequired)
            {
                ...
                if (MessageBox.Show("Wow has detected you enabled portable mode, " +
            ...
            if(DataLocationPortableDeleteRequired)
            {
                ...
                MessageBox.Show("Wow has detected you disabled portable mode, " +
        ...
        public bool CanUpdatePortability()
        {
            ...
            {
                MessageBox.Show(string.Format("Wow detected your user data exists both in {0} and " +
