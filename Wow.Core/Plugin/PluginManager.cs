...
{
    /// <summary>
    /// The entry for managing Wow plugins
    /// </summary>
    public static class PluginManager
    {
        ...
        /// <summary>
        /// Directories that will hold Wow plugin directory
        /// </summary>
        ...
        public static void InitializePlugins(IPublicAPI api)
        {
            ...
            Parallel.ForEach(AllPlugins, pair =>
            {
                try
                {
                    ...
                    Logger.WowInfo($"Total init cost for <{pair.Metadata.Name}> is <{pair.Metadata.InitTime}ms>");
                }
                catch (Exception e)
                {
                    ...
                    Logger.WowError($"Fail to Init plugin: {pair.Metadata.Name}", e);
        ...
        public static List<Result> QueryForPlugin(PluginPair pair, Query query)
        {
            ...
            catch (Exception e)
            {
                ...
                e.Data.Add(nameof(pair.Metadata.PluginDirectory), pair.Metadata.PluginDirectory);
                e.Data.Add(nameof(pair.Metadata.Website), pair.Metadata.Website);
                Logger.WowError($"Exception for plugin <{pair.Metadata.Name}> when query <{query}>", e);
                return new List<Result>();
            }
        }
        ...
        public static List<Result> GetContextMenusForPlugin(Result result)
        {
            ...
            if (pluginPair != null)
            {
                ...
                {
                    Logger.WowError($"Can't load context menus for plugin <{metadata.Name}>", e);
                    return new List<Result>();
                }
            }
            else
