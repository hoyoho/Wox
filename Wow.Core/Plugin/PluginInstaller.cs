    ...
    internal class PluginInstaller
    {
        internal static void Install(string path)
        {
            if (File.Exists(path))
            {
                ...
                string content = $"Do you want to install following plugin and restart Wow?{Environment.NewLine}{Environment.NewLine}" +
                ...
                content += $"{Environment.NewLine}{Environment.NewLine}If you choose No, the plugin will take effect since next time Wow starts.";
                ...
                if (result != MessageBoxResult.Cancel)
                {
                    ...
                    //current solution is to restart Wow. Ugly.
