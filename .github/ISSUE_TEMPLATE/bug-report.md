...
Please try reset Wow before continue, backup before you do.
...
**Wow Error Window text**
Paste below the logs generated by the Wow error reporter.
...
`%APPDATA%\Wow\Logs\version\<date>.txt`
