...
namespace Wow.Infrastructure.UserSettings
{
    public class Settings : BaseModel
    {
        ...
        private static WowJsonStorage<Settings> _storage = new WowJsonStorage<Settings>();
        ...
        public string QuerySearchPrecisionString
        {
            ...
            set
            {
                ...
                {
                    Logger.WowError("Failed to load QuerySearchPrecisionString value from Settings file", e);
        ...
        public bool StartWowOnSystemStartup { get; set; } = true;
