...
namespace Wow.Infrastructure.Logger
{
    public static class Log
    {
        ...
        public static void WowTrace(this NLog.Logger logger, string message, [CallerMemberName] string methodName = "")
        {
        ...
        public static void WowDebug(this NLog.Logger logger, string message, [CallerMemberName] string methodName = "")
        {
            Debug.WriteLine($"DEBUG|{logger.Name}|{methodName}|{message}");
        ...
        public static void WowInfo(this NLog.Logger logger, string message, [CallerMemberName] string methodName = "")
        {
            Debug.WriteLine($"INFO|{logger.Name}|{methodName}|{message}");
            logger.Info($"{methodName}|{message}");
        }

        public static void WowError(this NLog.Logger logger, string message, [CallerMemberName] string methodName = "")
        {
            Debug.WriteLine($"ERROR|{logger.Name}|{methodName}|{message}");
            logger.Error($"{methodName}|{message}");
        }

        public static void WowError(
