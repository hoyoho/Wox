...
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/hoyoho/wow?include_prereleases)](https://github.com/hoyoho/Wow/releases)
![GitHub Release Date](https://img.shields.io/github/release-date-pre/hoyoho/wow?nclude_prereleases)
[![Github All Releases](https://img.shields.io/github/downloads/hoyoho/Wow/total.svg)](https://github.com/hoyoho/Wow/releases)


**WoW** is a launcher for Windows that simply works. It's an alternative to [Alfred](https://www.alfredapp.com/) and [Launchy](http://www.launchy.net/).
...
- Build custom themes at http://www.wow.one/theme/builder
- Install plugins from http://www.wow.one/plugin
- Portable mode
...
- Download from [releases](https://github.com/hoyoho/Wow/releases).
...
- Requirements:
  - .NET >= 4.7.2 or Windows version >= 10 1607 (Anniversary Update)
  ...
  - [Optional] Use Python plugins
    ...
    2. add it to `%PATH%` or set it in WoW settings
...
- Reset: delete `%APPDATA%\Wow`
- Log: `%APPDATA%\Wow\Logs`
...
- I'd appreciate if you could solve [help_wanted](https://github.com/hoyoho/Wow/issues?q=is%3Aopen+is%3Aissue+label%3A%22help+wanted%22) labeled issue
...
Documentation
-------------
- [Wiki](https://github.com/hoyoho/Wow/wiki)
- Outdated doc: [WoW doc](http://doc.wow.one).
- Just ask questions in [issues](https://github.com/hoyoho/Wow/issues) for now.
