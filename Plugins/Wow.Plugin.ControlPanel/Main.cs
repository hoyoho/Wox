...
namespace Wow.Plugin.ControlPanel
{
    public class Main : IPlugin, IPluginI18n
    {
                    ...
                    var result = new Result
                    {
                        ...
                        Action = e =>
                        {
                            ...
                            catch (Exception ex)
                            {
                                ...
                                Logger.WowError($"cannot start control panel item {item.ExecutablePath}", ex);
                            }
                            return true;
                        }
                    };
        ...
        {
            return context.API.GetTranslation("wow_plugin_controlpanel_plugin_name");
        }

        public string GetTranslatedPluginDescription()
        {
            return context.API.GetTranslation("wow_plugin_controlpanel_plugin_description");
        }
    }
}