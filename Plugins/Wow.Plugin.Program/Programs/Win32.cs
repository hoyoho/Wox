...
namespace Wow.Plugin.Program.Programs
{
    ...
    public class Win32 : IProgram
    {
        ...
        private static Win32 Win32Program(string path)
        {
            ...
            {
                Logger.WowError($"Permission denied {path}");
        ...
        private static IEnumerable<string> ProgramPaths(string directory, string[] suffixes)
        {
            ...
            {
                Logger.WowError($"Permission denied {directory}");
            }
            catch (DirectoryNotFoundException)
            {
                Logger.WowError($"Directory not found {directory}");
            }
        ...
        private static string GetProgramPathFromRegistrySubKeys(RegistryKey root, string subkey)
        {
            ...
            {
                Logger.WowError($"Permission denied {root.ToString()} {subkey}");
                return string.Empty;
            }
        }
        ...
        public static Win32[] All(Settings settings)
        {
            ...
            {
                Logger.WowError("Cannot read win32", e);
                return new Win32[] { };
            }
