...
namespace Wow.Plugin.Program
{
    ...
    public partial class ProgramSuffixes
    {
        ...
        private void ButtonBase_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                string warning = context.API.GetTranslation("wow_plugin_program_suffixes_cannot_empty");
                MessageBox.Show(warning);
                return;
            }

            _settings.ProgramSuffixes = tbSuffixes.Text.Split(Settings.SuffixSeperator);
            string msg = context.API.GetTranslation("wow_plugin_program_update_file_suffixes");
            MessageBox.Show(msg);
