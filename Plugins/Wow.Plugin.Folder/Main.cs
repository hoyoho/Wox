...
namespace Wow.Plugin.Folder
{
    public class Main : IPlugin, ISettingProvider, IPluginI18n, ISavable, IContextMenu
    {
        ...
        {
            return _context.API.GetTranslation("wow_plugin_folder_plugin_name");
        }

        public string GetTranslatedPluginDescription()
        {
            return _context.API.GetTranslation("wow_plugin_folder_plugin_description");
        }
