...
### Define `plugin.json`
 ...
 ```
 {
    ...
    "Version":"1.0",
    "Language":"python",
    "Website":"https://github.com/Wow-launche/Wow",
...
Use pre-defined wow integrations by importing `Wow`
 - `from wow import Wow`
 - Make a `class` and pass `Wow` as an argument to it
