        ...
        private ImageSource SetImage(Result result)
        {
            ...
            if (string.IsNullOrEmpty(imagePath) && result.Icon != null)
            {
                ...
                catch (Exception e)
                {
                    ...
                    Logger.WowError($"IcoPath is empty and exception when calling Icon() for result <{r.Title}> of plugin <{r.PluginDirectory}>", e);
            ...
            catch (Exception e)
            {
                ...
                e.Data.Add(nameof(result.PluginDirectory), result.PluginDirectory);
                e.Data.Add(nameof(result.IcoPath), result.IcoPath);
                Logger.WowError($"Cannot read image {result.IcoPath}", e);
                return ImageLoader.GetErrorImage();
            }
        }
