...
using Wow.ViewModel;
using Stopwatch = Wow.Infrastructure.Stopwatch;
...
namespace Wow
{
    public partial class App : IDisposable, ISingleInstanceApp
    {
        ...
        private const string Unique = "Wow_Unique_Application_Mutex";
        ...
        private void OnStartup(object sender, StartupEventArgs e)
        {
            Logger.StopWatchNormal("Startup cost", () =>
            {
                ...
                Logger.WowInfo(ExceptionFormatter.RuntimeInfo());
                ...
                Current.MainWindow.Title = Constant.Wow;
                ...
                Logger.WowInfo($"SDK Info: {ExceptionFormatter.SDKInfo()}");
                Logger.WowInfo("End Wow startup ----------------------------------------------------  ");
            });
        }

        private static void InsertWowLanguageIntoLog()
        {
        ...
        {
            if (Settings.Instance.StartWowOnSystemStartup)
            {
        ...
        public void Dispose()
        {
            Logger.WowInfo("Wow Start Displose");
            ...
            Logger.WowInfo("Wow End Displose");
        }
